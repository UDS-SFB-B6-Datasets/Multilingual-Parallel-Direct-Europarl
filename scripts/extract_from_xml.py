...
def get_comparable(xml_dir, lang, src_lang, parallel_langs:Optional[Union[list, str]]=None, native=None, direct=0):
...
def main(xml_dir, outdir, lang, src_lang, parallel_langs, native, direct):
    comparable = get_comparable(xml_dir, lang, src_lang, parallel_langs, native, direct)
